...
description:
  Index of Secure by Design principle identifiers, categories, source mappings,
  and cross-references
---

# Index of Secure by Design Principles

This document provides the index for the Secure by Design principles. Each entry
synthesizes related guidance from the UK Government Secure by Design Principles
and the Australian ASD/ACSC Secure by Design Foundations into a unified
principle area.
...
1. Source mapping — which UK principle and AU foundation the content derives
   from.
2. Description — what the principle covers and why it matters.
3. Principle checklist — observable indicators that the codebase or project
...
Source: Australian Signals Directorate, Australian Cyber Security Centre, last
updated July 2024.
