---
description:
  'Writing style conventions for voice, tone, and language in markdown content'
applyTo: '**/*.md'
---

# Writing Style Instructions

These instructions define writing style, voice, and tone conventions for
markdown content. Apply these conventions to maintain consistency and
authenticity across documentation.
...
For community-facing communication patterns, follow the guidelines in
`community-interaction.instructions.md`.

### Formal Contexts

Use these conventions for strategic documents, architecture decisions, and
...
Use these conventions for guides, tutorials, how-tos, and developer-facing
content:
...
- Use rich, varied vocabulary to avoid repetitive word choices within close
  proximity
...
- Avoid jargon unless the audience expects it; define terms when introducing
  them
...
- Use longer, more complex sentences for narrative explanations and
  context-setting
...
Do not use em dashes (—) for parenthetical statements, explanations, or dramatic
pauses. Use these alternatives instead:
...
Avoid meta-commentary about the document itself. Start with the content directly
instead of phrases like "This document explains..." or "This page will show
you..."
...
Use GitHub-flavored markdown alerts for important callouts. Each alert type
...
Adaptability is the hallmark of effective writing style. Shift register based on
content purpose:
