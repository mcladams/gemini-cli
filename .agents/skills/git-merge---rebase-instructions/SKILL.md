---
name: git-merge---rebase-instructions
description: Use this guidance whenever coordinating Git merge, rebase, or `rebase --onto` sequences through the companion prompt. Follow every step even when the ...
---
