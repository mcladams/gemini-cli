---
name: bash-script-instructions
description: These instructions define conventions for authoring Bash scripts in this repository. Scripts follow Bash 5.x conventions with strict error handling an...
---
