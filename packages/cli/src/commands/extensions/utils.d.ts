...
export declare function getExtensionAndManager(
...
>;
export declare function configureSpecificSetting(
  extensionManager: ExtensionManager,
...
export declare function configureExtension(
  extensionManager: ExtensionManager,
  extensionName: string,
  scope: ExtensionSettingScope,
  logger?: ConfigLogger,
...
export declare function configureAllExtensions(
  extensionManager: ExtensionManager,
  scope: ExtensionSettingScope,
  logger?: ConfigLogger,
  requestSetting?: RequestSettingCallback,
...
export declare function configureExtensionSettings(
...
export declare function getFormattedSettingValue(
