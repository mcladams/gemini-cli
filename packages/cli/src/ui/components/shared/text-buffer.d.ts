...
export declare function expandPastePlaceholders(
  text: string,
...
export declare const isDifferentScript: (
  char1: string,
  char2: string,
) => boolean;
export declare const findNextWordStartInLine: (
  line: string,
  col: number,
) => number | null;
export declare const findPrevWordStartInLine: (
  line: string,
  col: number,
) => number | null;
export declare const findWordEndInLine: (
  line: string,
  col: number,
) => number | null;
export declare const findNextBigWordStartInLine: (
  line: string,
  col: number,
) => number | null;
export declare const findPrevBigWordStartInLine: (
  line: string,
  col: number,
) => number | null;
export declare const findBigWordEndInLine: (
  line: string,
  col: number,
) => number | null;
export declare const findNextWordAcrossLines: (
  lines: string[],
  cursorRow: number,
  cursorCol: number,
...
export declare const findPrevWordAcrossLines: (
  lines: string[],
  cursorRow: number,
  cursorCol: number,
) => {
...
export declare const findNextBigWordAcrossLines: (
  lines: string[],
  cursorRow: number,
  cursorCol: number,
  searchForWordStart: boolean,
...
export declare const findPrevBigWordAcrossLines: (
  lines: string[],
  cursorRow: number,
  cursorCol: number,
) => {
...
export declare const getPositionFromOffsets: (
  startOffset: number,
  endOffset: number,
  lines: string[],
) => {
...
export declare const getLineRangeOffsets: (
  startRow: number,
  lineCount: number,
  lines: string[],
) => {
...
export declare const replaceRangeInternal: (
...
export declare function offsetToLogicalPos(
  text: string,
  offset: number,
): [number, number];
/**
 ...
 */
export declare function logicalPosToOffset(
  lines: string[],
  row: number,
  col: number,
): number;
...
export declare function calculateTransformationsForLine(
  line: string,
): Transformation[];
export declare function calculateTransformations(
  lines: string[],
): Transformation[][];
export declare function getTransformUnderCursor(
  row: number,
  col: number,
 ...
 */
export declare function getExpandedPasteAtLine(
  lineIndex: number,
  expandedPaste: ExpandedPasteInfo | null,
): string | null;
/**
 ...
 */
export declare function shiftExpandedRegions(
  expandedPaste: ExpandedPasteInfo | null,
 ...
 */
export declare function detachExpandedPaste(
  state: TextBufferState,
): TextBufferState;
export declare function calculateTransformedLine(
  logLine: string,
  logIndex: number,
...
export declare function textBufferReducer(
  state: TextBufferState,
