...
export declare const SELECTION_PANE_WIDTH_PERCENTAGE = 0.45;
/** The fraction of the dialog width allocated to the preview (right) pane. */
export declare const PREVIEW_PANE_WIDTH_PERCENTAGE = 0.55;
/**
