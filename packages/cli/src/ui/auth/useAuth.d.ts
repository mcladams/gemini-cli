...
export declare const useAuthCommand: (
  ...
  initialAccountSuspensionInfo?: AccountSuspensionInfo | null,
) => {
  authState: AuthState;
  ...
  setAccountSuspensionInfo: import('react').Dispatch<
    import('react').SetStateAction<AccountSuspensionInfo | null>
  >;
};
