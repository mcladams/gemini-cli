...
export declare function isBackgroundExecutionData(
  data: unknown,
 ...
 */
export declare abstract class BaseToolInvocation<
  TParams extends object,
  TResult extends ToolResult,
> implements ToolInvocation<TParams, TResult> {
  ...
  readonly _toolAnnotations?: Record<string, unknown> | undefined;
  readonly respectsAutoEdit: boolean;
  readonly getApprovalMode: () => ApprovalMode;
  constructor(
    params: TParams,
    messageBus: MessageBus,
    _toolName?: string | undefined,
    _toolDisplayName?: string | undefined,
 ...
 */
export declare abstract class DeclarativeTool<
  TParams extends object,
  TResult extends ToolResult,
> implements ToolBuilder<TParams, TResult> {
   ...
   */
  private addWaitForPreviousParameter;
 ...
 */
export declare abstract class BaseDeclarativeTool<
  TParams extends object,
  TResult extends ToolResult,
...
export declare function isStructuredToolResult(
  obj: unknown,
): obj is StructuredToolResult;
export declare const hasSummary: (res: unknown) => res is {
  summary: string;
};
...
export declare const isGrepResult: (res: unknown) => res is GrepResult;
export declare const isListResult: (
  res: unknown,
) => res is ListDirectoryResult | ReadManyFilesResult;
export declare const isReadManyFilesResult: (
  res: unknown,
) => res is ReadManyFilesResult;
...
export declare const isFileDiff: (res: unknown) => res is FileDiff;
...
export declare const READ_ONLY_KINDS: Kind[];
