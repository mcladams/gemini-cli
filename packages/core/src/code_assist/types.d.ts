 ...
 */
export declare const UserTierId: {
  readonly FREE: 'free-tier';
  readonly LEGACY: 'legacy-tier';
  readonly STANDARD: 'standard-tier';
};
...
>;
export declare const RequiredMcpServerConfigSchema: z.ZodObject<
  {
    url: z.ZodString;
    type: z.ZodEnum<['sse', 'http']>;
    authProviderType: z.ZodOptional<z.ZodNativeEnum<typeof AuthProviderType>>;
    oauth: z.ZodOptional<
      z.ZodObject<
        {
...
export declare const McpConfigDefinitionSchema: z.ZodObject<
  {
    mcpServers: z.ZodOptional<
      ...
      >
    >;
    requiredMcpServers: z.ZodOptional<
      z.ZodRecord<
        z.ZodString,
        z.ZodObject<
          {
            ...
            authProviderType: z.ZodOptional<
              z.ZodNativeEnum<typeof AuthProviderType>
            >;
            oauth: z.ZodOptional<
              z.ZodObject<
                {
...
export declare const AdminControlsSettingsSchema: z.ZodObject<
  {
    strictModeDisabled: z.ZodOptional<z.ZodBoolean>;
    mcpSetting: z.ZodOptional<
      z.ZodObject<
        {
          ...
          mcpConfig: z.ZodOptional<
                    ...
                    z.ZodObject<
                      {
                        ...
                        type: z.ZodOptional<z.ZodEnum<['sse', 'http']>>;
                        trust: z.ZodOptional<z.ZodBoolean>;
                        includeTools: z.ZodOptional<
                          z.ZodArray<z.ZodString, 'many'>
                        >;
                        excludeTools: z.ZodOptional<
                          z.ZodArray<z.ZodString, 'many'>
                        >;
                      },
                      'strip',
            ...
            >
          >;
          requiredMcpConfig: z.ZodOptional<
            z.ZodRecord<
              z.ZodString,
              z.ZodObject<
                {
      ...
      >
    >;
    cliFeatureSetting: z.ZodOptional<
      z.ZodObject<
        {
          extensionsSetting: z.ZodOptional<
            z.ZodObject<
              {
...
export declare const FetchAdminControlsResponseSchema: z.ZodObject<
  {
    ...
    mcpSetting: z.ZodOptional<
      z.ZodObject<
        {
          mcpEnabled: z.ZodOptional<z.ZodBoolean>;
          mcpConfigJson: z.ZodOptional<z.ZodString>;
        },
        'strip',
        z.ZodTypeAny,
        {
    ...
    cliFeatureSetting: z.ZodOptional<
      ...
      >
    >;
    adminControlsApplicable: z.ZodOptional<z.ZodBoolean>;
  },
  'strip',
  z.ZodTypeAny,
  {
    ...
    cliFeatureSetting?:
      ...
      | undefined;
    adminControlsApplicable?: boolean | undefined;
  },
  {
    secureModeEnabled?: boolean | undefined;
    strictModeDisabled?: boolean | undefined;
