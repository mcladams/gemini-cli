 ...
 */
export declare const DEFAULT_QUERY_STRING = 'Get Started!';
/**
 * The default maximum number of conversational turns for an agent.
 */
export declare const DEFAULT_MAX_TURNS = 30;
/**
 * The default maximum execution time for an agent in minutes.
 */
export declare const DEFAULT_MAX_TIME_MINUTES = 10;
/**
 ...
 */
export declare enum SubagentActivityErrorType {
  REJECTED = 'REJECTED',
  CANCELLED = 'CANCELLED',
  GENERIC = 'GENERIC',
}
 ...
 */
export declare const SUBAGENT_REJECTED_ERROR_PREFIX =
  'User rejected this operation.';
export declare const SUBAGENT_CANCELLED_ERROR_MESSAGE = 'Request cancelled.';
...
export declare function isSubagentProgress(
  obj: unknown,
): obj is SubagentProgress;
/**
 * Checks if the tool call data indicates an error.
 */
export declare function isToolActivityError(data: unknown): boolean;
/**
 ...
 */
export declare function getAgentCardLoadOptions(
  def: RemoteAgentRef,
 ...
 */
export declare function getRemoteAgentTargetUrl(
  def: RemoteAgentRef,
): string | undefined;
