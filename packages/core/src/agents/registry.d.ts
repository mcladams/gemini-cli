...
import { type AgentDefinition, type AgentReloadSummary } from './types.js';
...
export declare const DYNAMIC_RULE_SOURCE = 'AgentRegistry (Dynamic)';
/**
...
export declare class AgentRegistry {
   ...
   */
  reload(): Promise<AgentReloadSummary>;
  /**
   ...
   */
  protected registerRemoteAgent<TOutput extends z.ZodTypeAny>(
    definition: AgentDefinition<TOutput>,
    errors?: string[],
  ): Promise<void>;
