 ...
 */
declare const GUI_EDITORS: readonly [
  'vscode',
  'vscodium',
  'windsurf',
  'cursor',
...
export declare const NO_EDITOR_AVAILABLE_ERROR =
...
export declare function isGuiEditor(
  editor: EditorType,
): editor is GuiEditorType;
export declare function isTerminalEditor(
  editor: EditorType,
...
export declare function hasValidEditorCommandAsync(
  editor: EditorType,
): Promise<boolean>;
 ...
 * Returns false if preferred editor is not set / invalid / not available / not allowed in sandbox.
 */
export declare function isEditorAvailableAsync(
 ...
 */
export declare function resolveEditorAsync(
