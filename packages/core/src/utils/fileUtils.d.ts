...
export declare function readWasmBinaryFromDisk(
  specifier: string,
): Promise<Uint8Array>;
 ...
 */
export declare function getRealPath(filePath: string): string;
/**
 ...
 */
export declare function isEmpty(filePath: string): Promise<boolean>;
/**
 ...
 */
export declare function sanitizeFilenamePart(part: string): string;
/**
 ...
 */
export declare function formatTruncatedToolOutput(
  contentStr: string,
  outputFile: string,
  maxChars: number,
): string;
...
export declare function saveTruncatedToolOutput(
  content: string,
  toolName: string,
