 ...
 */
export declare function getCommandName(
  command: string,
  args: string[],
): Promise<string>;
/**
 ...
 */
export declare function extractStringFromParseEntry(entry: ParseEntry): string;
...
export declare const REDIRECTION_NAMES: Set<string>;
/**
 ...
 */
export declare function normalizeCommand(commandName: string): string;
export declare function parseBashCommandDetails(
  command: string,
