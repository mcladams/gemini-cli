...
export declare const DEFAULT_MAX_ATTEMPTS = 10;
...
export declare const INCOMPLETE_JSON_MESSAGE = 'incomplete json segment';
/**
 * Categorizes an error for retry telemetry purposes.
 * Returns a safe string without PII.
 */
export declare function getRetryErrorType(error: unknown): string;
/**
