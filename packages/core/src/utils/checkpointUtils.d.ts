...
>;
export declare function generateCheckpointFileName(
  toolCall: ToolCallRequestInfo,
): string | null;
export declare function formatCheckpointDisplayList(
  filenames: string[],
): string;
export declare function getTruncatedCheckpointNames(
  filenames: string[],
): string[];
export declare function processRestorableToolCalls<HistoryType>(
...
export declare function getCheckpointInfoList(
