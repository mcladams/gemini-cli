 ...
 */
export declare function getHookSource(
 ...
 */
export declare const MODES_BY_PERMISSIVENESS: ApprovalMode[];
/**
 ...
 */
export declare const PRIORITY_SUBAGENT_TOOL = 1.03;
/**
 * The fractional priority of "Always allow" rules (e.g., 950/1000).
 * Higher fraction within a tier wins.
 */
export declare const ALWAYS_ALLOW_PRIORITY_FRACTION = 950;
/**
 ...
 */
export declare const ALWAYS_ALLOW_PRIORITY_OFFSET: number;
/**
 * Priority for the YOLO "allow all" rule.
 * Matches the raw priority used in yolo.toml.
 */
export declare const PRIORITY_YOLO_ALLOW_ALL = 998;
