...
declare const OVERAGE_OPTION_COUNT = 'gemini_cli.overage_option.count';
declare const CREDIT_PURCHASE_COUNT = 'gemini_cli.credit_purchase.count';
declare const GEN_AI_CLIENT_TOKEN_USAGE = 'gen_ai.client.token.usage';
declare const GEN_AI_CLIENT_OPERATION_DURATION =
...
declare const EVENT_LOOP_DELAY = 'gemini_cli.event_loop.delay';
...
declare const BASELINE_COMPARISON =
...
declare const COUNTER_DEFINITIONS: {
  ...
  readonly 'gemini_cli.network_retry.count': {
    readonly description: 'Counts network retries.';
    readonly valueType: ValueType.INT;
    readonly assign: (c: Counter) => Counter<Attributes>;
    readonly attributes: {
      model: string;
  ...
  readonly 'gemini_cli.overage_option.count': {
    readonly description: 'Counts overage option selections.';
    readonly valueType: ValueType.INT;
    readonly assign: (c: Counter) => Counter<Attributes>;
    readonly attributes: {
  ...
  readonly 'gemini_cli.credit_purchase.count': {
    readonly description: 'Counts credit purchase link clicks.';
    readonly valueType: ValueType.INT;
    readonly assign: (c: Counter) => Counter<Attributes>;
    readonly attributes: {
      source: string;
  ...
  readonly 'gemini_cli.browser_agent.connection.failure.count': {
    readonly description: 'Counts browser agent MCP connection failures.';
    readonly valueType: ValueType.INT;
    readonly assign: (c: Counter) => Counter<Attributes>;
    readonly attributes: {
  ...
  readonly 'gemini_cli.browser_agent.tools.missing_semantic': {
    readonly description: 'Counts missing required semantic tools discovered from MCP.';
    readonly valueType: ValueType.INT;
    readonly assign: (c: Counter) => Counter<Attributes>;
    readonly attributes: {
      tool_name: string;
  ...
  readonly 'gemini_cli.browser_agent.vision.status': {
    readonly description: 'Counts browser agent invocations by vision status.';
    readonly valueType: ValueType.INT;
    readonly assign: (c: Counter) => Counter<Attributes>;
    readonly attributes: {
      enabled: boolean;
  ...
  readonly 'gemini_cli.browser_agent.task.outcome': {
    readonly description: 'Counts browser agent task outcomes.';
    readonly valueType: ValueType.INT;
    readonly assign: (c: Counter) => Counter<Attributes>;
    readonly attributes: {
      success: boolean;
  ...
  readonly 'gemini_cli.browser_agent.cleanup.failure.count': {
    readonly description: 'Counts browser agent cleanup failures.';
    readonly valueType: ValueType.INT;
    readonly assign: (c: Counter) => Counter<Attributes>;
    readonly attributes: {
      session_mode: 'persistent' | 'isolated' | 'existing';
  ...
  readonly 'gemini_cli.onboarding.start': {
    readonly description: 'Counts onboarding started';
    readonly valueType: ValueType.INT;
    readonly assign: (c: Counter) => Counter<Attributes>;
    readonly attributes: Record<string, never>;
  };
  readonly 'gemini_cli.onboarding.success': {
    readonly description: 'Counts onboarding succeeded';
    readonly valueType: ValueType.INT;
    readonly assign: (c: Counter) => Counter<Attributes>;
    readonly attributes: {
      user_tier?: string;
...
declare const HISTOGRAM_DEFINITIONS: {
  ...
  readonly 'gemini_cli.browser_agent.connection.duration': {
    readonly description: 'Duration of browser agent MCP connection setup in milliseconds.';
    readonly unit: 'ms';
    readonly valueType: ValueType.INT;
    readonly assign: (h: Histogram) => Histogram<Attributes>;
    readonly attributes: {
  ...
  readonly 'gemini_cli.browser_agent.tools.discovered': {
    readonly description: 'Count of tools discovered from chrome-devtools-mcp.';
    readonly unit: 'tools';
    readonly valueType: ValueType.INT;
    readonly assign: (h: Histogram) => Histogram<Attributes>;
    readonly attributes: {
  ...
  readonly 'gemini_cli.browser_agent.task.duration': {
    readonly description: 'Full invocation duration of browser agent (connect + run + cleanup) in milliseconds.';
    readonly unit: 'ms';
    readonly valueType: ValueType.INT;
    readonly assign: (h: Histogram) => Histogram<Attributes>;
    readonly attributes: {
  ...
  readonly 'gemini_cli.browser_agent.cleanup.duration': {
    readonly description: 'Duration of browser agent cleanup in milliseconds.';
    readonly unit: 'ms';
    readonly valueType: ValueType.INT;
    readonly assign: (h: Histogram) => Histogram<Attributes>;
    readonly attributes: {
  ...
  readonly 'gemini_cli.onboarding.duration': {
    readonly description: 'Duration of onboarding in milliseconds.';
    readonly unit: 'ms';
    readonly valueType: ValueType.INT;
    readonly assign: (h: Histogram) => Histogram<Attributes>;
    readonly attributes: {
...
declare const PERFORMANCE_HISTOGRAM_DEFINITIONS: {
  ...
  readonly 'gemini_cli.event_loop.delay': {
    readonly description: 'Event loop delay in milliseconds.';
    readonly unit: 'ms';
    readonly valueType: ValueType.DOUBLE;
    readonly assign: (h: Histogram) => Histogram<Attributes>;
    readonly attributes: {
 ...
 */
export declare function recordOnboardingStart(config: Config): void;
/**
 * Records a metric for when the Google auth process ends successfully.
 */
export declare function recordOnboardingSuccess(
  config: Config,
  userTier?: string,
  durationMs?: number,
): void;
 ...
 */
export declare function recordPlanExecution(
  config: Config,
 ...
 */
export declare function recordSlowRender(
  config: Config,
...
export declare function recordRetryAttemptMetrics(
  config: Config,
  attributes: {
    model: string;
    attempt: number;
...
export declare function recordModelRoutingMetrics(
  config: Config,
...
export declare function recordEventLoopDelay(
  config: Config,
  delayMs: number,
  attributes: MetricDefinitions[typeof EVENT_LOOP_DELAY]['attributes'],
): void;
export declare function recordToolQueueDepth(
  config: Config,
  queueDepth: number,
): void;
...
export declare function recordHookCallMetrics(
  config: Config,
 ...
 */
export declare function recordKeychainAvailability(
  config: Config,
 ...
 */
export declare function recordTokenStorageInitialization(
  config: Config,
 ...
 */
export declare function recordOverageOptionSelected(
  config: Config,
 ...
 */
export declare function recordCreditPurchaseClick(
  config: Config,
  attributes: MetricDefinitions[typeof CREDIT_PURCHASE_COUNT]['attributes'],
): void;
export declare function recordBrowserAgentConnection(
  config: Config,
  durationMs: number,
  attributes: {
    session_mode: 'persistent' | 'isolated' | 'existing';
...
export declare function recordBrowserAgentToolDiscovery(
  config: Config,
  toolCount: number,
  missingSemanticTools: string[],
  sessionMode: 'persistent' | 'isolated' | 'existing',
): void;
export declare function recordBrowserAgentVisionStatus(
  config: Config,
  attributes: {
    enabled: boolean;
    disabled_reason?:
...
export declare function recordBrowserAgentTaskOutcome(
  config: Config,
  attributes: {
    success: boolean;
    session_mode: 'persistent' | 'isolated' | 'existing';
...
export declare function recordBrowserAgentCleanup(
  config: Config,
  durationMs: number,
  attributes: {
    session_mode: 'persistent' | 'isolated' | 'existing';
