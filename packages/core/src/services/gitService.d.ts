...
export declare const SHADOW_REPO_AUTHOR_NAME = 'Gemini CLI';
export declare const SHADOW_REPO_AUTHOR_EMAIL = 'gemini-cli@google.com';
export declare class GitService {
  ...
  static verifyGitAvailability(): Promise<boolean>;
  private getShadowRepoEnv;
  /**
