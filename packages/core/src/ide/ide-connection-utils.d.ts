...
export declare function validateWorkspacePath(
...
export declare function getConnectionConfigFromFile(pid: number): Promise<
  | (ConnectionConfig & {
  ...
  | undefined
>;
export declare function createProxyAwareFetch(
  ideServerHost: string,
